...
SELECT DISTINCT  C.APELLIDOS, C.NOMBRES, CAT.Nombre AS CATEGORIA FROM CLIENTES C
INNER JOIN PEDIDOS PED ON PED.IDCLIENTE= C.ID
INNER JOIN PRODUCTOS PROD ON PED.IDProducto = PROD.ID
